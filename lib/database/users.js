...
export class UserData extends data {
    ...
    static _schema = z.object({
        ...
        health: z.number().default(200),
         atm: z.number().min(0).default(0),

        dana: z.number().min(0).default(0),

        gopay: z.number().min(0).default(0),

        pulsa: z.number().min(0).default(0),
        ...
        vippass: z.number().min(0).default(0),
        royalpass: z.number().min(0).default(0),
