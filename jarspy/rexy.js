...
let apalah = fs.readFileSync('./vn/menul.mp3') 
...
If you find any errors or want to upgrade your premium plan, please contact the Owner.
%readmore
`.trimStart(),
  header: '╭─「 %category 」',
  body: `│ • %cmd %islimit %isPremium `,
  footer: '╰────\n',
  after: `Elaina AI By ManzKenz ${global.version}`,
}
  try {
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴇʟᴀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaJMOH7CHDyls9qnPm25', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
